...
public class WizardBuilder implements InterfaceBuilder {
    ...
    public InterfaceBuilder setMeleeAttack(int meleeAttack) {
        if ( meleeAttack != WIZ_MELEE_ATTACK ) {
    ...
    public GameInterface build() {
        return new Wizard(characterName, health, armor, 
